...
public class Controlador {
    ...
    public Controlador (VendedoresFRM v){
        this.vista = v;
        this.vista.btn_listar.addActionListener((ActionListener) this);
        this.vista.btn_crear.addActionListener((ActionListener) this);
        this.vista.btn_editar.addActionListener((ActionListener) this);
        this.vista.btn_actualizar.addActionListener((ActionListener) this);
        this.vista.btn_eliminar1.addActionListener((ActionListener) this);
        listar(vista.TABLA);
    }
